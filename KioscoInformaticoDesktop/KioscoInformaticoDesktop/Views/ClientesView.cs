...
namespace KioscoInformaticoDesktop.Views
{
    public partial class ClientesView : Form
    {
        ...
        private async Task CargarGrilla()
        {
            ...
            //dataGridClientesView.Columns["Ventas"].Visible = false;
            //dataGridClientesView.Columns["FechaNacimiento"].Visible = false;
            //dataGridClientesView.Columns["Id"].Visible = false;
            //dataGridClientesView.Columns["Nombre"].HeaderText = "Nombre";
            //dataGridClientesView.Columns["Direccion"].HeaderText = "Dirección";
            //dataGridClientesView.Columns["Telefonos"].HeaderText = "Teléfonos";
            //dataGridClientesView.Columns["Localidad"].HeaderText = "Localidad";
        }
